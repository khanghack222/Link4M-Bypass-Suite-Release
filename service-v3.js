(function() {
	var traffic_key = "\x33\x44\x51\x73\x42\x7A";
	var traffic_id = "\x62\x38\x62\x35\x37\x66\x62\x64\x34\x32\x37\x63\x66\x62\x64\x61\x35\x36\x66\x64\x34\x61\x32\x32\x66\x35\x35\x36\x35\x32\x65\x62";
	var traffic_domain = 's1.what-on.com';
	var v2ab57 = '6aa528b52b76a62efe0e180f';
	var uuid_name = '\x74\x72\x61\x66\x66\x69\x63\x5F\x70\x67\x45\x5A\x74\x33\x44\x51\x73\x42\x7A';
				...
				button.addEventListener(clickHandler, function(){
					...
					detectIncognito().then((result) => {
						if(result.isPrivate){
							...
							var params = 'traffic_session=' + v2ab57 + '&key=' + traffic_key + '&' + jscd_param;
							xmlhttp.send(params);
		...
		if((element.dataset.loading == undefined || element.dataset.loading == 'false')
			...
			switch(step){
				case 2 :
					...
					var jscd_param =  new URLSearchParams(jscd).toString();
					xmlhttp.open("GET", "https://" + traffic_domain + "/widget/get_quest_code.html?id=" + quest_info.id + "&code=" + traffic_id + '&traffic_session=' + v2ab57 + '&key=' + traffic_key + '&' + jscd_param, true);
					xmlhttp.send();
					break;
				case 1:
				default:
					...
					var jscd_param =  new URLSearchParams(jscd).toString();
					xmlhttp.open("GET", "https://" + traffic_domain + "/widget/get_quest_code.html?code=" + traffic_id + '&traffic_session=' + v2ab57 + '&key=' + traffic_key + '&' + jscd_param, true);
					xmlhttp.send();
					break;
